...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-amber-500 to-amber-600 text-white">
      {/* CTA Section */}
      <div className="container mx-auto px-4 py-6 text-center">
        <h2 className="text-2xl font-bold text-white mb-3">
          Ready to Order?
        </h2>
        <p className="text-white/90 text-base mb-4 max-w-2xl mx-auto">
          Experience the best food delivery service in town.
        </p>
        <div className="flex flex-col md:flex-row items-center justify-center gap-3">
          <Link
            href="/cart"
            className="inline-block bg-white text-amber-600 px-8 py-3 rounded-full font-semibold hover:bg-amber-50 transition-colors"
          >
            View Cart
          </Link>
          <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-6xl mx-auto">
          ...
          <div className="space-y-2 transform hover:scale-105 transition-transform duration-300">
            <div className="flex items-center space-x-2">
              ...
              />
              <h2 className="text-base font-bold text-white">Muchachos Food</h2>
            </div>
          ...
          <div className="space-y-2">
            <h3 className="text-base font-semibold text-white">Contact & Hours</h3>
